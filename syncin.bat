...
IF %STATUS% NEQ 0 rsync -rhtv --delete --progress --partial --partial-dir=.rsync-partial --no-perms --no-owner --no-group --modify-window=5 --exclude-from /cygdrive/d/Ameer/rsync-excludes.txt rsync://user@%HOST%/usb1/Laptop/ /cygdrive/d
